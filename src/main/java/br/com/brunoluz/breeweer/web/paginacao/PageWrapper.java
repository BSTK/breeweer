package br.com.brunoluz.breeweer.web.paginacao;
...
public class PageWrapper<T> {
	...
	public String urlOrdenada(String propriedade) {
		...
		String propriedadeOrdenada = String.format("%s,%s", propriedade, inverterDirecao(propriedade));
		
		return uriBuilderOrder.replaceQueryParam("sort", propriedadeOrdenada).build(true).encode().toUriString();
